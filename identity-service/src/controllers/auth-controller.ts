...
class AuthController {
  async signup(req: Request, res: Response) {
    try {
      ...
      return successResponse(res, { accessToken }, 'User signed up successfully', StatusCodes.CREATED);
    } catch (error : any) {
  ...
  async login(req: Request, res: Response) {
    try {
      ...
      return successResponse(res, { accessToken }, 'User logged in successfully', StatusCodes.OK);
    } catch (error : any) {
      return errorResponse(res, error.message || 'Internal Server Error', error.statusCode || StatusCodes.INTERNAL_SERVER_ERROR);
    }
  }
